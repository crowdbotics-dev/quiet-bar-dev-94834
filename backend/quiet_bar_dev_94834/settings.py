"""
Django settings for quiet_bar_dev_94834 project.
...
ROOT_URLCONF = 'quiet_bar_dev_94834.urls'
...
WSGI_APPLICATION = 'quiet_bar_dev_94834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_bar_dev_94834 API",
    "DESCRIPTION": "API documentation for quiet_bar_dev_94834 App",
    "VERSION": "v1",
}
